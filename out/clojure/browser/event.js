...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj6342 = {};return obj6342;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__4858__auto__ = this$;if(and__4858__auto__)
...
{var x__5507__auto__ = (((this$ == null))?null:this$);return (function (){var or__4870__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5507__auto__)]);if(or__4870__auto__)
{return or__4870__auto__;
} else
{var or__4870__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__4870__auto____$1)
...
return (function (p__6343){var vec__6344 = p__6343;var k = cljs.core.nth.call(null,vec__6344,(0),null);var v = cljs.core.nth.call(null,vec__6344,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__6345){var vec__6346 = p__6345;var k = cljs.core.nth.call(null,vec__6346,(0),null);var v = cljs.core.nth.call(null,vec__6346,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
